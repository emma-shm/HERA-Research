...
df1['event_time_unix_s'] = (pd.to_datetime(df1['utc_time'], utc=True) - epoch).dt.total_seconds()
df2['event_time_unix_s'] = (pd.to_datetime(df2['utc_time'], utc=True) - epoch).dt.total_seconds()
df2['event_time_unix_s_t2'] = df2['event_time_unix_s']
